<nav id="main-menu">
      <ul>
        ...
        <li><a href="http://ila.edu.vn/stories" title="Chuyện hay của ILA">Chuyện hay của ILA</a></li>
		{{-- <li>
			<a href="javascript:void(0);" title="English (UK)" onclick="javascript:set_lang('english');"><img src="http://ila.edu.vn/front/images/flag-uk.svg" alt="English"><span>&nbsp;</span></a>
        </li> --}}
        <li class=""><a href="http://ila.edu.vn/request-callback" title="Liên hệ" class="btn-contact">Liên hệ</a></li>
      </ul>
</nav>
