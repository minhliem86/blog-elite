            ...
            <div class="box">
                <div class="box-header">
                  <div class="pull-right">
                    <a href="{!!route('admin.student.create')!!}" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-plus"></i> Add New</a>
    ...
    $(document).ready(function(){
        ...
        var table = $('#table-post').DataTable({
            ...
            columns: [
               ...
               {data: 'status', name: 'students.status', 'orderable': false},
